...
import { editLanguage, getLanguageByID } from "../../../api/requests";
import { Helmet, HelmetProvider } from "react-helmet-async";

const MovieLanguageEdit = () => {
  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Edit Movie Language</title>
        </Helmet>
      </HelmetProvider>
      {loading ? (
        <section id="loader">
        ...
        >
          <div className="container">
            ...
            >
              <h2 style={{ fontWeight: "600" }}>Edit Language Name</h2>
              <TextField
                name="name"
                id="standard-basic"
                label="Language Name"
...
export default MovieLanguageEdit;
