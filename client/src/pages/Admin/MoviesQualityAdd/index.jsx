...
import { postQuality } from "../../../api/requests";
import { Helmet, HelmetProvider } from "react-helmet-async";

const MoviesQualityAdd = () => {
  ...
  function handleSubmit(values, actions) {
    postQuality(values);
    toast.success("Quality posted successfully!", {
      position: "top-right",
      autoClose: 5000,
    ...
    <>
      ...
      >
        <div className="container">
          ...
          >
            <h2 style={{ fontWeight: "600" }}>Add Movie Quality</h2>
            <TextField
              name="name"
              id="standard-basic"
              label="Quality Name"
...
export default MoviesQualityAdd;
